/**
 * Where Qwen Web reads its settings, and the shapes everything else here uses.
 *
...
export const CONFIG_DIR = path.join(os.homedir(), ".cline", "qwen-web");
export const CONFIG_FILE = path.join(CONFIG_DIR, "config.json");
export const QWEN_WEB_URL = "https://chat.qwen.ai/";
export const QWEN_API_ENDPOINT = "/api/v2/chat/completions";
...
export function requestQwenThrottleRecoveryReload(): void {
	qwenRecoverFromThrottle = true;
}

export function consumeQwenThrottleRecoveryReload(): boolean {
