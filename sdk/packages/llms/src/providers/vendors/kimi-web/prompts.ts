...
export const kimiWebPrompts: WebProviderPrompts = {
	...
	// Unset: a worker keeps the shared tool contract. Fill this in to change
	// how Kimi is briefed as a teammate — the role text the manager wrote is
	// appended after whatever is here, under a "# Team Teammate Role" heading.
	worker: undefined,
