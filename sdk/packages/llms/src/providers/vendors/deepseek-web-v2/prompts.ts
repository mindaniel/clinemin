...
/**
 * DeepSeek Web v2's three prompts.
 *
 ...
 * `default` and `worker`.
 */
export const deepseekWebV2Prompts: WebProviderPrompts = {
	// The human-in-the-loop prompt: PowerShell to read with, a patch block to
	// edit with. DeepSeek is a strong reasoner behind a scraped chat box, not a
	...
	//
	// `deepseek-web-v2` is on the `web-chat-providers-use-apply-patch` rule in
